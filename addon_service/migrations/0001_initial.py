    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authorized_storage_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addon_service.authorizedstorageaccount')),
                ('internal_resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configured_storage_addons', to='addon_service.internalresource')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addon_service.externalaccount'),
        ),
        migrations.AddField(
            model_name='authorizedstorageaccount',
            name='external_storage_service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='addon_service.externalstorageservice'),
        ),
    ]
